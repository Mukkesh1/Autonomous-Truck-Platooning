...
% Trucks dynamically adjust speeds using sensors to accommodate intervening cars, 
% maintaining platoon integrity and safe distances.
...
function dz = simulation(t,z,parameters)
    ...
    truck_4_width   =  parameters.truck_4_width;
    ...
    % Cut in detection between trucks three and four.
    car2_width = parameters.car2_width;     % Width of Car2
    car2_rear_right_corner_lateral_pos = car2_pos_lat - car2_width/2;
    if car2_rear_right_corner_lateral_pos < truck_4_width/2 && car2_rear_right_corner_lateral_pos>=-2
        % If car2 in front
        Truck_4_sensors.distance_preceding  = (car2_pos_lon-car2_length) - truck_4_position;
        Truck_4_sensors.speed_preceding     = car2_speed; 
    else
         % If truck three in front
    ...
    % Lateral speed car2 (kinematic model)
    if car2_pos_lat >= -4.3 && car_pos_lon >= 380.0
        dz(14,1) = -2.0;
    else
